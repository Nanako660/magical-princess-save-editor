  ...
  <section class="editor-section">
    ...
    <div class="card-grid">
      ...
      <div class="card-grid-item card-grid-item--half">
        <n-card title="结局标记" size="small">
          <n-space vertical :size="12">
            <n-checkbox v-model:checked="gstatus.isShowTrueEnding">已显示真结局</n-checkbox>
            <n-checkbox v-model:checked="gstatus.isShowAnotherEnding">已显示隐藏结局</n-checkbox>
            <n-checkbox v-model:checked="gstatus.isNextLoopStart">下周目开始</n-checkbox>
          </n-space>
        </n-card>
      </div>
...
<script>
import { NForm, NGrid, NFormItemGi, NInputNumber, NInput, NCard, NCheckbox, NSpace } from 'naive-ui'

export default {
  name: 'GlobalEditor',
  components: { NForm, NGrid, NFormItemGi, NInputNumber, NInput, NCard, NCheckbox, NSpace },
  props: {
    gstatus: {
      type: Object,
      required: true
