...
export default {
  name: 'BasicEditor',
  components: { NForm, NGrid, NFormItemGi, NInputNumber, NSelect, NInputGroup, NInputGroupLabel },
  props: {
